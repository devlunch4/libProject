...
//$$$$
		...
		Map<String, Object> user = libuserDao.selectUser(usernoselect, password);
...
//7 관리자계정 자동입력 libController.Loginadminno; 사용
		String loginadminno = (String) libController.Loginadminno.get("ADMINID");

		String addusersql = "INSERT INTO libuser VALUES ('" + adduserno + "', '" + adduname + "', TO_DATE('" + addubirth
				+ "', 'YYYYMMDD'), '" + adduadrs + "', '" + addutel + "', SYSDATE, '" + loginadminno + "')";
