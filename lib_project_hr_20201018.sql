...
commit;
--4대여내역테이블
--내역번호2회원번호3isbn번호4대여일5반납일6반납예상일7연장가능유무(초기값1)/0일경우 1번 연장함
--대여내역추가
INSERT INTO libhistory VALUES(1,'1234567891',1111112345, TO_DATE('20201011', 'YYYYMMDD'), null,TO_DATE('20201011', 'YYYYMMDD') + 10, 1);
